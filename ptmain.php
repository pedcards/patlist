...
$id = $xml->xpath("id[@mrn='".$mrn."']");
    ...
    $PMleads = $PMtemp[0]->xpath('temp[last()]')[0];
        ...
        $pmt_mode  = $PMleads->mode;
        $pmt_LRL   = $PMleads->LRL;
        $pmt_URL   = $PMleads->URL;
        $pmt_AVI   = $PMleads->AVI;
        $pmt_PVARP = $PMleads->PVARP;
        $pmt_ApThr = $PMleads->ApThr;
        $pmt_AsThr = $PMleads->AsThr;
        $pmt_VpThr = $PMleads->VpThr;
        $pmt_VsThr = $PMleads->VsThr;
        $pmt_Ap    = $PMleads->Ap;
        $pmt_As    = $PMleads->As;
        $pmt_Vp    = $PMleads->Vp;
        $pmt_Vs    = $PMleads->Vs;
        $pmt_notes = $PMleads->notes;
    $prov = $id[0]->prov;
